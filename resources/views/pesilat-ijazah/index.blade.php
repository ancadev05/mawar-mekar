...
@section('content')
    ...
    <nav class="mb-3">
        <ul class="nav nav-tabs justify-content-center">
            <li class="nav-item">
                <a class="nav-link active" href="#">Siswa 1</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#">Siswa 2</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#">Siswa 3</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#">Siswa 4</a>
            </li>
        </ul>
    </nav>
    ...
    <section class="card p-3">
        ...
        <table class="table table-sm mb-4">
            <tr>
                <td class="">Nama</td>
                <td class="fw-bold">: NUR AIRIN</td>
            </tr>
            <tr>
                <td class="">Tempat, Tanggal Lahir</td>
                <td class="fw-bold">: Takalar, 24 Januari 2024</td>
            </tr>
        </table>
