...
@section('content')
    ...
    <nav class="mb-3">
        <ul class="nav nav-tabs justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="{{ url('/ijazah/2') }}">Siswa 2</a>
            </li>
            <li class="nav-item">
    ...
    <section class="card p-3">
        ...
        <div class="mb-3 text-center">
            ...
            <h4 class="text-center fw-bold">== SISWA DUA ==</h4>
            <img src="{{ url('assets/img/tanda-tingkat/s2.png') }}" alt="foto" height="25px" class="mb-1">
        </div>
