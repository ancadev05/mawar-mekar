            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control @error('unit') is-invalid @enderror" type="text" name="unit"
                        id="unit" value="{{ $unit->unit }}" required>
                ...
                <div class="mb-3">
                    <label class="form-label" for="pelatih_lama">Penanggung Jawab Sekarang</label>
                    <small class="d-block text-info"><i>untuk ubah penanggung jawab bisa langsung dihapus dan diganti dengan yang baru pada isian berikutnya</i></small>
                    <input type="text" name="pelatih_lama" value="{{ $unit->penanggung_jawab }}" class="form-control">
                </div>
                <div class="mb-3">
                    <label class="form-label" for="penanggung_jawab">Penanggung Jawab Baru</label>
